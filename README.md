...
完整部落格文章連結：https://poychang.github.io/use-thired-party-package-to-implement-ldap-authenticate-in-dotnet-core/

建立專案的相關指令：

```
dotnet new console -n DemoDotnetCoreNovellLdap
